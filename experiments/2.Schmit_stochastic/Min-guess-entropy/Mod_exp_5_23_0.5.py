...
Beta = 0.5
M = [50, 6, 2, 86, 3, 170, 2, 2, 7, 139, 3, 1, 2, 10, 4, 1, 10, 1, 4, 5, 2, 1, 1]
T = [9.3267900390625, 4.4059755859375, 4.725695703125, 5.145680859375, 5.0252169921875, 9.8999828125, 9.1527982421875, 9.4278884765625, 9.6065638671875, 5.562, 9.365755078125, 9.2016375, 9.2432044921875, 5.5164658203125, 5.3303234375, 9.3197408203125, 9.8983423828125, 9.4035083984375, 5.290244140625, 9.6095240234375, 5.404190234375, 9.33968203125, 9.553840234375]
N = 23
k = 0
for y in T:
   min = y
...
m.addConstr(x00 + x01 + x02 + x03 + x04 + x05 + x06 + x07 + x08 + x09 + x010 + x011 + x012 + x013 + x014 + x015 + x016 + x017 + x018 + x019 + x020 + x021 + x022 == 1)
m.addConstr(x10 + x11 + x12 + x13 + x14 + x15 + x16 + x17 + x18 + x19 + x110 + x111 + x112 + x113 + x114 + x115 + x116 + x117 + x118 + x119 + x120 + x121 + x122 == 1)
m.addConstr(x20 + x21 + x22 + x23 + x24 + x25 + x26 + x27 + x28 + x29 + x210 + x211 + x212 + x213 + x214 + x215 + x216 + x217 + x218 + x219 + x220 + x221 + x222 == 1)
m.addConstr(x30 + x31 + x32 + x33 + x34 + x35 + x36 + x37 + x38 + x39 + x310 + x311 + x312 + x313 + x314 + x315 + x316 + x317 + x318 + x319 + x320 + x321 + x322 == 1)
m.addConstr(x40 + x41 + x42 + x43 + x44 + x45 + x46 + x47 + x48 + x49 + x410 + x411 + x412 + x413 + x414 + x415 + x416 + x417 + x418 + x419 + x420 + x421 + x422 == 1)
m.addConstr(x50 + x51 + x52 + x53 + x54 + x55 + x56 + x57 + x58 + x59 + x510 + x511 + x512 + x513 + x514 + x515 + x516 + x517 + x518 + x519 + x520 + x521 + x522 == 1)
m.addConstr(x60 + x61 + x62 + x63 + x64 + x65 + x66 + x67 + x68 + x69 + x610 + x611 + x612 + x613 + x614 + x615 + x616 + x617 + x618 + x619 + x620 + x621 + x622 == 1)
m.addConstr(x70 + x71 + x72 + x73 + x74 + x75 + x76 + x77 + x78 + x79 + x710 + x711 + x712 + x713 + x714 + x715 + x716 + x717 + x718 + x719 + x720 + x721 + x722 == 1)
m.addConstr(x80 + x81 + x82 + x83 + x84 + x85 + x86 + x87 + x88 + x89 + x810 + x811 + x812 + x813 + x814 + x815 + x816 + x817 + x818 + x819 + x820 + x821 + x822 == 1)
m.addConstr(x90 + x91 + x92 + x93 + x94 + x95 + x96 + x97 + x98 + x99 + x910 + x911 + x912 + x913 + x914 + x915 + x916 + x917 + x918 + x919 + x920 + x921 + x922 == 1)
m.addConstr(x100 + x101 + x102 + x103 + x104 + x105 + x106 + x107 + x108 + x109 + x1010 + x1011 + x1012 + x1013 + x1014 + x1015 + x1016 + x1017 + x1018 + x1019 + x1020 + x1021 + x1022 == 1)
m.addConstr(x110 + x111 + x112 + x113 + x114 + x115 + x116 + x117 + x118 + x119 + x1110 + x1111 + x1112 + x1113 + x1114 + x1115 + x1116 + x1117 + x1118 + x1119 + x1120 + x1121 + x1122 == 1)
m.addConstr(x120 + x121 + x122 + x123 + x124 + x125 + x126 + x127 + x128 + x129 + x1210 + x1211 + x1212 + x1213 + x1214 + x1215 + x1216 + x1217 + x1218 + x1219 + x1220 + x1221 + x1222 == 1)
m.addConstr(x130 + x131 + x132 + x133 + x134 + x135 + x136 + x137 + x138 + x139 + x1310 + x1311 + x1312 + x1313 + x1314 + x1315 + x1316 + x1317 + x1318 + x1319 + x1320 + x1321 + x1322 == 1)
m.addConstr(x140 + x141 + x142 + x143 + x144 + x145 + x146 + x147 + x148 + x149 + x1410 + x1411 + x1412 + x1413 + x1414 + x1415 + x1416 + x1417 + x1418 + x1419 + x1420 + x1421 + x1422 == 1)
m.addConstr(x150 + x151 + x152 + x153 + x154 + x155 + x156 + x157 + x158 + x159 + x1510 + x1511 + x1512 + x1513 + x1514 + x1515 + x1516 + x1517 + x1518 + x1519 + x1520 + x1521 + x1522 == 1)
m.addConstr(x160 + x161 + x162 + x163 + x164 + x165 + x166 + x167 + x168 + x169 + x1610 + x1611 + x1612 + x1613 + x1614 + x1615 + x1616 + x1617 + x1618 + x1619 + x1620 + x1621 + x1622 == 1)
m.addConstr(x170 + x171 + x172 + x173 + x174 + x175 + x176 + x177 + x178 + x179 + x1710 + x1711 + x1712 + x1713 + x1714 + x1715 + x1716 + x1717 + x1718 + x1719 + x1720 + x1721 + x1722 == 1)
m.addConstr(x180 + x181 + x182 + x183 + x184 + x185 + x186 + x187 + x188 + x189 + x1810 + x1811 + x1812 + x1813 + x1814 + x1815 + x1816 + x1817 + x1818 + x1819 + x1820 + x1821 + x1822 == 1)
m.addConstr(x190 + x191 + x192 + x193 + x194 + x195 + x196 + x197 + x198 + x199 + x1910 + x1911 + x1912 + x1913 + x1914 + x1915 + x1916 + x1917 + x1918 + x1919 + x1920 + x1921 + x1922 == 1)
m.addConstr(x200 + x201 + x202 + x203 + x204 + x205 + x206 + x207 + x208 + x209 + x2010 + x2011 + x2012 + x2013 + x2014 + x2015 + x2016 + x2017 + x2018 + x2019 + x2020 + x2021 + x2022 == 1)
m.addConstr(x210 + x211 + x212 + x213 + x214 + x215 + x216 + x217 + x218 + x219 + x2110 + x2111 + x2112 + x2113 + x2114 + x2115 + x2116 + x2117 + x2118 + x2119 + x2120 + x2121 + x2122 == 1)
m.addConstr(x220 + x221 + x222 + x223 + x224 + x225 + x226 + x227 + x228 + x229 + x2210 + x2211 + x2212 + x2213 + x2214 + x2215 + x2216 + x2217 + x2218 + x2219 + x2220 + x2221 + x2222 == 1)
m.addConstr(constant >= (M[0])*x00*(T[0]) + (M[0])*x01*(T[1]) + (M[0])*x02*(T[2]) + (M[0])*x03*(T[3]) + (M[0])*x04*(T[4]) + (M[0])*x05*(T[5]) + (M[0])*x06*(T[6]) + (M[0])*x07*(T[7]) + (M[0])*x08*(T[8]) + (M[0])*x09*(T[9]) + (M[0])*x010*(T[10]) + (M[0])*x011*(T[11]) + (M[0])*x012*(T[12]) + (M[0])*x013*(T[13]) + (M[0])*x014*(T[14]) + (M[0])*x015*(T[15]) + (M[0])*x016*(T[16]) + (M[0])*x017*(T[17]) + (M[0])*x018*(T[18]) + (M[0])*x019*(T[19]) + (M[0])*x020*(T[20]) + (M[0])*x021*(T[21]) + (M[0])*x022*(T[22]) + (M[1])*x11*(T[1]) + (M[1])*x12*(T[2]) + (M[1])*x13*(T[3]) + (M[1])*x14*(T[4]) + (M[1])*x15*(T[5]) + (M[1])*x16*(T[6]) + (M[1])*x17*(T[7]) + (M[1])*x18*(T[8]) + (M[1])*x19*(T[9]) + (M[1])*x110*(T[10]) + (M[1])*x111*(T[11]) + (M[1])*x112*(T[12]) + (M[1])*x113*(T[13]) + (M[1])*x114*(T[14]) + (M[1])*x115*(T[15]) + (M[1])*x116*(T[16]) + (M[1])*x117*(T[17]) + (M[1])*x118*(T[18]) + (M[1])*x119*(T[19]) + (M[1])*x120*(T[20]) + (M[1])*x121*(T[21]) + (M[1])*x122*(T[22]) + (M[2])*x22*(T[2]) + (M[2])*x23*(T[3]) + (M[2])*x24*(T[4]) + (M[2])*x25*(T[5]) + (M[2])*x26*(T[6]) + (M[2])*x27*(T[7]) + (M[2])*x28*(T[8]) + (M[2])*x29*(T[9]) + (M[2])*x210*(T[10]) + (M[2])*x211*(T[11]) + (M[2])*x212*(T[12]) + (M[2])*x213*(T[13]) + (M[2])*x214*(T[14]) + (M[2])*x215*(T[15]) + (M[2])*x216*(T[16]) + (M[2])*x217*(T[17]) + (M[2])*x218*(T[18]) + (M[2])*x219*(T[19]) + (M[2])*x220*(T[20]) + (M[2])*x221*(T[21]) + (M[2])*x222*(T[22]) + (M[3])*x33*(T[3]) + (M[3])*x34*(T[4]) + (M[3])*x35*(T[5]) + (M[3])*x36*(T[6]) + (M[3])*x37*(T[7]) + (M[3])*x38*(T[8]) + (M[3])*x39*(T[9]) + (M[3])*x310*(T[10]) + (M[3])*x311*(T[11]) + (M[3])*x312*(T[12]) + (M[3])*x313*(T[13]) + (M[3])*x314*(T[14]) + (M[3])*x315*(T[15]) + (M[3])*x316*(T[16]) + (M[3])*x317*(T[17]) + (M[3])*x318*(T[18]) + (M[3])*x319*(T[19]) + (M[3])*x320*(T[20]) + (M[3])*x321*(T[21]) + (M[3])*x322*(T[22]) + (M[4])*x44*(T[4]) + (M[4])*x45*(T[5]) + (M[4])*x46*(T[6]) + (M[4])*x47*(T[7]) + (M[4])*x48*(T[8]) + (M[4])*x49*(T[9]) + (M[4])*x410*(T[10]) + (M[4])*x411*(T[11]) + (M[4])*x412*(T[12]) + (M[4])*x413*(T[13]) + (M[4])*x414*(T[14]) + (M[4])*x415*(T[15]) + (M[4])*x416*(T[16]) + (M[4])*x417*(T[17]) + (M[4])*x418*(T[18]) + (M[4])*x419*(T[19]) + (M[4])*x420*(T[20]) + (M[4])*x421*(T[21]) + (M[4])*x422*(T[22]) + (M[5])*x55*(T[5]) + (M[5])*x56*(T[6]) + (M[5])*x57*(T[7]) + (M[5])*x58*(T[8]) + (M[5])*x59*(T[9]) + (M[5])*x510*(T[10]) + (M[5])*x511*(T[11]) + (M[5])*x512*(T[12]) + (M[5])*x513*(T[13]) + (M[5])*x514*(T[14]) + (M[5])*x515*(T[15]) + (M[5])*x516*(T[16]) + (M[5])*x517*(T[17]) + (M[5])*x518*(T[18]) + (M[5])*x519*(T[19]) + (M[5])*x520*(T[20]) + (M[5])*x521*(T[21]) + (M[5])*x522*(T[22]) + (M[6])*x66*(T[6]) + (M[6])*x67*(T[7]) + (M[6])*x68*(T[8]) + (M[6])*x69*(T[9]) + (M[6])*x610*(T[10]) + (M[6])*x611*(T[11]) + (M[6])*x612*(T[12]) + (M[6])*x613*(T[13]) + (M[6])*x614*(T[14]) + (M[6])*x615*(T[15]) + (M[6])*x616*(T[16]) + (M[6])*x617*(T[17]) + (M[6])*x618*(T[18]) + (M[6])*x619*(T[19]) + (M[6])*x620*(T[20]) + (M[6])*x621*(T[21]) + (M[6])*x622*(T[22]) + (M[7])*x77*(T[7]) + (M[7])*x78*(T[8]) + (M[7])*x79*(T[9]) + (M[7])*x710*(T[10]) + (M[7])*x711*(T[11]) + (M[7])*x712*(T[12]) + (M[7])*x713*(T[13]) + (M[7])*x714*(T[14]) + (M[7])*x715*(T[15]) + (M[7])*x716*(T[16]) + (M[7])*x717*(T[17]) + (M[7])*x718*(T[18]) + (M[7])*x719*(T[19]) + (M[7])*x720*(T[20]) + (M[7])*x721*(T[21]) + (M[7])*x722*(T[22]) + (M[8])*x88*(T[8]) + (M[8])*x89*(T[9]) + (M[8])*x810*(T[10]) + (M[8])*x811*(T[11]) + (M[8])*x812*(T[12]) + (M[8])*x813*(T[13]) + (M[8])*x814*(T[14]) + (M[8])*x815*(T[15]) + (M[8])*x816*(T[16]) + (M[8])*x817*(T[17]) + (M[8])*x818*(T[18]) + (M[8])*x819*(T[19]) + (M[8])*x820*(T[20]) + (M[8])*x821*(T[21]) + (M[8])*x822*(T[22]) + (M[9])*x99*(T[9]) + (M[9])*x910*(T[10]) + (M[9])*x911*(T[11]) + (M[9])*x912*(T[12]) + (M[9])*x913*(T[13]) + (M[9])*x914*(T[14]) + (M[9])*x915*(T[15]) + (M[9])*x916*(T[16]) + (M[9])*x917*(T[17]) + (M[9])*x918*(T[18]) + (M[9])*x919*(T[19]) + (M[9])*x920*(T[20]) + (M[9])*x921*(T[21]) + (M[9])*x922*(T[22]) + (M[10])*x1010*(T[10]) + (M[10])*x1011*(T[11]) + (M[10])*x1012*(T[12]) + (M[10])*x1013*(T[13]) + (M[10])*x1014*(T[14]) + (M[10])*x1015*(T[15]) + (M[10])*x1016*(T[16]) + (M[10])*x1017*(T[17]) + (M[10])*x1018*(T[18]) + (M[10])*x1019*(T[19]) + (M[10])*x1020*(T[20]) + (M[10])*x1021*(T[21]) + (M[10])*x1022*(T[22]) + (M[11])*x1111*(T[11]) + (M[11])*x1112*(T[12]) + (M[11])*x1113*(T[13]) + (M[11])*x1114*(T[14]) + (M[11])*x1115*(T[15]) + (M[11])*x1116*(T[16]) + (M[11])*x1117*(T[17]) + (M[11])*x1118*(T[18]) + (M[11])*x1119*(T[19]) + (M[11])*x1120*(T[20]) + (M[11])*x1121*(T[21]) + (M[11])*x1122*(T[22]) + (M[12])*x1212*(T[12]) + (M[12])*x1213*(T[13]) + (M[12])*x1214*(T[14]) + (M[12])*x1215*(T[15]) + (M[12])*x1216*(T[16]) + (M[12])*x1217*(T[17]) + (M[12])*x1218*(T[18]) + (M[12])*x1219*(T[19]) + (M[12])*x1220*(T[20]) + (M[12])*x1221*(T[21]) + (M[12])*x1222*(T[22]) + (M[13])*x1313*(T[13]) + (M[13])*x1314*(T[14]) + (M[13])*x1315*(T[15]) + (M[13])*x1316*(T[16]) + (M[13])*x1317*(T[17]) + (M[13])*x1318*(T[18]) + (M[13])*x1319*(T[19]) + (M[13])*x1320*(T[20]) + (M[13])*x1321*(T[21]) + (M[13])*x1322*(T[22]) + (M[14])*x1414*(T[14]) + (M[14])*x1415*(T[15]) + (M[14])*x1416*(T[16]) + (M[14])*x1417*(T[17]) + (M[14])*x1418*(T[18]) + (M[14])*x1419*(T[19]) + (M[14])*x1420*(T[20]) + (M[14])*x1421*(T[21]) + (M[14])*x1422*(T[22]) + (M[15])*x1515*(T[15]) + (M[15])*x1516*(T[16]) + (M[15])*x1517*(T[17]) + (M[15])*x1518*(T[18]) + (M[15])*x1519*(T[19]) + (M[15])*x1520*(T[20]) + (M[15])*x1521*(T[21]) + (M[15])*x1522*(T[22]) + (M[16])*x1616*(T[16]) + (M[16])*x1617*(T[17]) + (M[16])*x1618*(T[18]) + (M[16])*x1619*(T[19]) + (M[16])*x1620*(T[20]) + (M[16])*x1621*(T[21]) + (M[16])*x1622*(T[22]) + (M[17])*x1717*(T[17]) + (M[17])*x1718*(T[18]) + (M[17])*x1719*(T[19]) + (M[17])*x1720*(T[20]) + (M[17])*x1721*(T[21]) + (M[17])*x1722*(T[22]) + (M[18])*x1818*(T[18]) + (M[18])*x1819*(T[19]) + (M[18])*x1820*(T[20]) + (M[18])*x1821*(T[21]) + (M[18])*x1822*(T[22]) + (M[19])*x1919*(T[19]) + (M[19])*x1920*(T[20]) + (M[19])*x1921*(T[21]) + (M[19])*x1922*(T[22]) + (M[20])*x2020*(T[20]) + (M[20])*x2021*(T[21]) + (M[20])*x2022*(T[22]) + (M[21])*x2121*(T[21]) + (M[21])*x2122*(T[22]) + (M[22])*x2222*(T[22]))
...
print(rTime)
f1 = open("res_Mod_exp_5_23_0.5.txt",'w')
f1.write('\n')
f1.write(str(rTime))
f1.write('\n')
for d in m.getVars():
