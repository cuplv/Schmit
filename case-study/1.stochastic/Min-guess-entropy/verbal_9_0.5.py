...
Beta = 0.5
M = [1100, 100, 200, 100, 100, 100, 100, 100, 100]
T = [6.99275, 23.9445, 26.30315, 13.2465, 19.9592, 10.7167, 11.88555, 17.0915, 18.5715]
N = 9
k = 0
for y in T:
   min = y
...
m.addConstr(x00 + x01 + x02 + x03 + x04 + x05 + x06 + x07 + x08 == 1)
m.addConstr(x10 + x11 + x12 + x13 + x14 + x15 + x16 + x17 + x18 == 1)
m.addConstr(x20 + x21 + x22 + x23 + x24 + x25 + x26 + x27 + x28 == 1)
m.addConstr(x30 + x31 + x32 + x33 + x34 + x35 + x36 + x37 + x38 == 1)
m.addConstr(x40 + x41 + x42 + x43 + x44 + x45 + x46 + x47 + x48 == 1)
m.addConstr(x50 + x51 + x52 + x53 + x54 + x55 + x56 + x57 + x58 == 1)
m.addConstr(x60 + x61 + x62 + x63 + x64 + x65 + x66 + x67 + x68 == 1)
m.addConstr(x70 + x71 + x72 + x73 + x74 + x75 + x76 + x77 + x78 == 1)
m.addConstr(x80 + x81 + x82 + x83 + x84 + x85 + x86 + x87 + x88 == 1)
m.addConstr(constant >= (M[0])*x00*(T[0]) + (M[0])*x01*(T[1]) + (M[0])*x02*(T[2]) + (M[0])*x03*(T[3]) + (M[0])*x04*(T[4]) + (M[0])*x05*(T[5]) + (M[0])*x06*(T[6]) + (M[0])*x07*(T[7]) + (M[0])*x08*(T[8]) + (M[1])*x11*(T[1]) + (M[1])*x12*(T[2]) + (M[1])*x13*(T[3]) + (M[1])*x14*(T[4]) + (M[1])*x15*(T[5]) + (M[1])*x16*(T[6]) + (M[1])*x17*(T[7]) + (M[1])*x18*(T[8]) + (M[2])*x22*(T[2]) + (M[2])*x23*(T[3]) + (M[2])*x24*(T[4]) + (M[2])*x25*(T[5]) + (M[2])*x26*(T[6]) + (M[2])*x27*(T[7]) + (M[2])*x28*(T[8]) + (M[3])*x33*(T[3]) + (M[3])*x34*(T[4]) + (M[3])*x35*(T[5]) + (M[3])*x36*(T[6]) + (M[3])*x37*(T[7]) + (M[3])*x38*(T[8]) + (M[4])*x44*(T[4]) + (M[4])*x45*(T[5]) + (M[4])*x46*(T[6]) + (M[4])*x47*(T[7]) + (M[4])*x48*(T[8]) + (M[5])*x55*(T[5]) + (M[5])*x56*(T[6]) + (M[5])*x57*(T[7]) + (M[5])*x58*(T[8]) + (M[6])*x66*(T[6]) + (M[6])*x67*(T[7]) + (M[6])*x68*(T[8]) + (M[7])*x77*(T[7]) + (M[7])*x78*(T[8]) + (M[8])*x88*(T[8]))
...
print(rTime)
f1 = open("res_verbal_9_0.5.txt",'w')
f1.write('\n')
f1.write(str(rTime))
f1.write('\n')
for d in m.getVars():
