...
Beta = 0.5
M = [15, 215, 39, 82, 46, 39, 30, 13, 43, 42, 39, 10, 31, 26, 26, 26, 8, 14, 33, 23]
T = [2.97, 9.984, 7.623, 9.955, 7.179, 6.089, 11.504, 4.417, 6.735, 8.447, 6.898, 3.515, 10.508, 2.535, 9.532, 10.039, 1.746, 3.795, 4.995, 11.556]
N = 20
k = 0
for y in T:
   min = y
...
print(rTime)
f1 = open("res_jetty_20_0.5.txt",'w')
f1.write('\n')
f1.write(str(rTime))
f1.write('\n')
for d in m.getVars():
